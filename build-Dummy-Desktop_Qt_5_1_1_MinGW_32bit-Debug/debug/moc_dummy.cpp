...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Dummy_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 33, 16)
    ...
    "Dummy\0on_actionAuthor_triggered\0\0"
    "on_Close_clicked\0"
};
...
void Dummy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_actionAuthor_triggered(); break;
...
const QMetaObject Dummy::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Dummy.data,
      qt_meta_data_Dummy,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Dummy.stringdata))
